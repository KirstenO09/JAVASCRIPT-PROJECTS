...
const Calculator = {
    //This will display e on the calculator screen.
    Display_Value: '',
...
function Input_Digit(digit) {
    ...
    //This checks if the Wait Second_Operand is true and sets Display Value
    //to the key that was clicked on.
    if (Wait_Second_Operand === true) {
        Calculator.Display_Value = digit;
        Calculator.Wait_Second_Operand = false;
    } else {
        //This overwrites Display_Value if the current value is e
