...
/*this function keeps the tasks permanetly displayed on the sczeen*/
function show() {
    ...
    /*This tells the browser how to display the todo array after an item has been remomoved*/
...
function remove() {
    ...
    todos.splice(id, 1);
    /*this saves the new list after the task was removed*/
    localStorage.setItem('todo', JSON.stringify(todos));
    show();
    return false;
}
